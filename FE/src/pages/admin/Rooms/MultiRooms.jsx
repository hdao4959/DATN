...
function MultiStepForm() {
    ...
    const handleSubmitForm4 = async () => {
        ...
        try {
            await api.post("/admin/classrooms", finalPayload);
    ...
    const renderButtons = () => (
        <div className="d-flex justify-content-between mt-3 text-center">
            ...
            {currentStep === 4 && (
                <button className="btn btn-success" onClick={handleSubmitForm4}>
                    Tạo lớp học
                </button>
            )}
        </div>
                    ...
                    <>
                        ...
                        {selectedParent &&
                            ...
                            (() => {
                                const selectedMajor = majors.find(
                                    (category) =>
                                        category.cate_code === selectedParent
                                );
                                const children = selectedMajor?.childrens || []; // Đảm bảo có giá trị mặc định là mảng rỗng

                                return (
                                    children.length > 0 && (
                                        <div className="form-group mb-3">
                                            <label>Chọn chuyên ngành con</label>
                                            <select
                                                className="form-control"
                                                value={selectedChild}
