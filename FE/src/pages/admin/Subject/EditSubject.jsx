        ...
        <div className="col-md-12">
          <div className="card">
            <div className="card-header">
              <div className="card-title text-center">Chỉnh sửa Môn Học</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmitForm)}>
        <div className="row">
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <div className="card-title">Cập nhật Môn Học</div>
              </div>
              <div className='card-body'>
                {(isLoadingMajor || isLoadingSubject) ? (
                  ...
                  <div className="row">
                    ...
                    <div className="card-action d-flex justify-content-end gap-x-3">
                      <button type="button" className="btn btn-danger" onClick={() => reset()}>
                        <i className='fas fa-undo'> Đặt lại</i>
                      </button>
                      <button type="submit" className="btn btn-success">
                        <i className='fas fa-plus'> Sửa</i>
                      </button>
                    </div>
                  </div>
                )}
