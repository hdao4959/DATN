...
const ShowGrades = ({ classCode, onClose }) => {
    ...
    return (
        <div>
            <div className="modal fade show d-block" tabIndex="-1" aria-labelledby="gradesModalLabel" role="dialog">
                        ...
                        <div className="modal-body">
                            {selectedGrade ? (
                                <div className="table-responsive">
                                    <table id="modalGradesTable" className="display table-striped"></table>
                                </div>
                            ) : (
