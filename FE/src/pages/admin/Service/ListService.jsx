...
const ServiceList = () => {
    ...
    const { data, isLoading, error } = useQuery({
        ...
        queryFn: async () => {
            const response = await api.get("services"); // Gọi API lấy dịch vụ
                    ...
                    <table id="serviceTable" className="table table-bordered table-striped">
                        <thead className="table-primary">
                            <tr>
                                <th>#</th>
                                <th>Tên dịch vụ</th>
                                <th>Mã học sinh</th> {/* Thêm cột Mã học sinh */}
                                <th>Học sinh</th>
                                <th>Trạng thái</th>
                                <th>Thao tác</th>
                            </tr>
                        ...
                        <tbody>
                            {data.data.data.map((service, index) => (
                                <tr key={service.id}>
                                    ...
                                    <td>{service.student ? service.student.user_code : "Chưa có học sinh"}</td> {/* Hiển thị mã học sinh */}
